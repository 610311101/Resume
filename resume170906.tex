...
\cventry{Sep}{改寫\textmd{tm}套件指令\textmd{termdocumentmatrix}。}{}{}{}{
\begin{itemize}
\item 有閱讀及改寫程式的能力。
\item 解決文本矩陣在中文上的轉換問題。
\end{itemize}
}{}
\cventry{2016--Oct}{爬取租屋網站的資料。}{}{}{}{}{}
\cventry{2017--Apr}{用\textmd{R}練習類神經網路的基礎模型。}{}{}{}{
\begin{itemize}
\item 自無到有，自己學習。
\item 了解back-propagation演算法。
\item 採取adadelta演算法來學習，用iris資料來驗證。
\end{itemize}
}{}
